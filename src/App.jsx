...
const SplashScreen = ({ onFinish }) => {
  ...
  return (
    <div className="h-full w-full bg-indigo-700 flex flex-col items-center justify-center text-white p-8">
...
export default function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-200 flex items-center justify-center p-4 font-sans antialiased selection:bg-indigo-100 selection:text-indigo-900">
      <style>{`
